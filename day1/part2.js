...
let map1 = {"one":"1","two":"2","three":"3","four":"4","five":"5","six":"6","seven":"7","eight":"8","nine":"9"}

for(let i = 0; i< input.length; i++){
    let res = Array.from(input[i].matchAll(/(?=(\d|one|two|three|four|five|six|seven|eight|nine))/gm), (match) => match[1]);
    res = res.map( e => map1.hasOwnProperty(e) ? map1[e] : e)
    count += Number(res[0] + res[res.length-1])
}
